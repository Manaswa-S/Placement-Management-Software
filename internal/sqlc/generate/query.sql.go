...
type CompletedInterviewsCompanyRow struct {
	...
	Extras          []byte
	FeedbackGiven   bool
	FeedbackID      pgtype.Int8
	FeedbackMessage pgtype.Text
}
...
func (q *Queries) DiscussionsData(ctx context.Context, arg DiscussionsDataParams) ([]DiscussionsDataRow, error) {
	rows, err := q.db.Query(ctx, discussionsData, arg.Offset, arg.Limit, arg.UserID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const feedbacksByCompaniesToStudent = `-- name: FeedbacksByCompaniesToStudent :many
SELECT 
    feedbacks.feedback_id,
...
type FeedbacksByCompaniesToStudentRow struct {
	FeedbackID          int64
	FeedbackTime        string
	ApplicationID       pgtype.Int8
	InterviewID         pgtype.Int8
	Message             pgtype.Text
	ApplicationFeedback bool
	InterviewFeedback   bool
	JobTitle            string
	CompanyName         string
}

func (q *Queries) FeedbacksByCompaniesToStudent(ctx context.Context, userID int64) ([]FeedbacksByCompaniesToStudentRow, error) {
	rows, err := q.db.Query(ctx, feedbacksByCompaniesToStudent, userID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []FeedbacksByCompaniesToStudentRow
	for rows.Next() {
		var i FeedbacksByCompaniesToStudentRow
		if err := rows.Scan(
			&i.FeedbackID,
			&i.FeedbackTime,
			&i.ApplicationID,
...
const feedbacksByCompanyUserToStudents = `-- name: FeedbacksByCompanyUserToStudents :many
SELECT 
    feedbacks.feedback_id,
    TO_CHAR(feedbacks.created_at, 'HH12:MI:SS AM DD-MM-YYYY') AS feedback_time,
    feedbacks.message,
...
type FeedbacksByCompanyUserToStudentsRow struct {
	FeedbackID          int64
	FeedbackTime        string
	Message             pgtype.Text
	ApplicationID       pgtype.Int8
...
func (q *Queries) FeedbacksByCompanyUserToStudents(ctx context.Context, userID int64) ([]FeedbacksByCompanyUserToStudentsRow, error) {
	rows, err := q.db.Query(ctx, feedbacksByCompanyUserToStudents, userID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []FeedbacksByCompanyUserToStudentsRow
	for rows.Next() {
		var i FeedbacksByCompanyUserToStudentsRow
		if err := rows.Scan(
			&i.FeedbackID,
			&i.FeedbackTime,
			&i.Message,
...
const feedbacksByStudentToCompanies = `-- name: FeedbacksByStudentToCompanies :many
SELECT 
    feedbacks.feedback_id,
    TO_CHAR(feedbacks.created_at, 'HH12:MI:SS AM DD-MM-YYYY') AS feedback_time,
    feedbacks.application_id,
...
type FeedbacksByStudentToCompaniesRow struct {
	FeedbackID          int64
	FeedbackTime        string
	ApplicationID       pgtype.Int8
	InterviewID         pgtype.Int8
...
func (q *Queries) FeedbacksByStudentToCompanies(ctx context.Context, userID int64) ([]FeedbacksByStudentToCompaniesRow, error) {
	rows, err := q.db.Query(ctx, feedbacksByStudentToCompanies, userID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []FeedbacksByStudentToCompaniesRow
	for rows.Next() {
		var i FeedbacksByStudentToCompaniesRow
		if err := rows.Scan(
			&i.FeedbackID,
			&i.FeedbackTime,
			&i.ApplicationID,
...
const feedbacksByStudentsToCompanyUser = `-- name: FeedbacksByStudentsToCompanyUser :many
WITH notuser AS (
    SELECT 
        interviews.interview_id 
    FROM interviews 
...
type FeedbacksByStudentsToCompanyUserRow struct {
	FeedbackID   int64
	FeedbackTime string
	Message      pgtype.Text
}

func (q *Queries) FeedbacksByStudentsToCompanyUser(ctx context.Context, userID int64) ([]FeedbacksByStudentsToCompanyUserRow, error) {
	rows, err := q.db.Query(ctx, feedbacksByStudentsToCompanyUser, userID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []FeedbacksByStudentsToCompanyUserRow
	for rows.Next() {
		var i FeedbacksByStudentsToCompanyUserRow
...
SELECT notif_id, user_id, title, description, read_status, timestamp 
FROM tb
`
...
func (q *Queries) GetReplies(ctx context.Context, threadID pgtype.Int8) ([]GetRepliesRow, error) {
	rows, err := q.db.Query(ctx, getReplies, threadID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const insertFeedbackByCompanyToStudent = `-- name: InsertFeedbackByCompanyToStudent :exec
INSERT INTO feedbacks (application_id, interview_id, user_id, message)
VALUES ($1, $2, $3, $4)
`

type InsertFeedbackByCompanyToStudentParams struct {
	ApplicationID pgtype.Int8
	InterviewID   pgtype.Int8
	UserID        int64
	Message       pgtype.Text
...
func (q *Queries) InsertFeedbackByCompanyToStudent(ctx context.Context, arg InsertFeedbackByCompanyToStudentParams) error {
	_, err := q.db.Exec(ctx, insertFeedbackByCompanyToStudent,
		arg.ApplicationID,
		arg.InterviewID,
		arg.UserID,
		arg.Message,
...
const insertFeedbackByStudentToCompany = `-- name: InsertFeedbackByStudentToCompany :exec
INSERT INTO feedbacks (application_id, interview_id, user_id, message)
VALUES ($1, $2, $3, $4)
`

type InsertFeedbackByStudentToCompanyParams struct {
	ApplicationID pgtype.Int8
	InterviewID   pgtype.Int8
	UserID        int64
	Message       pgtype.Text
...
func (q *Queries) InsertFeedbackByStudentToCompany(ctx context.Context, arg InsertFeedbackByStudentToCompanyParams) error {
	_, err := q.db.Exec(ctx, insertFeedbackByStudentToCompany,
		arg.ApplicationID,
		arg.InterviewID,
		arg.UserID,
		arg.Message,
